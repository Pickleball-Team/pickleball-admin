          ...
          <Panel header="Players" key="3">
            {matchFormat === 1 ? (
              <>
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item name="player1Id" label="Player 1">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[0]?.members.map(
                          (player: Member) => {
                  ...
                  <Col span={12}>
                    <Form.Item name="player2Id" label="Player 2">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[1]?.members.map(
                          (player: Member) => {
                            const user = getUserById(player.playerId);
                            return user ? (
                              <Option
              ...
              <>
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item name="player1Id" label="Team 1 - Player 1">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[0]?.members.map(
                          (player: Member) => {
                            const user = getUserById(player.playerId);
                  ...
                  <Col span={12}>
                    <Form.Item name="player2Id" label="Team 1 - Player 2">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[0]?.members.map(
                          (player: Member) => {
                            const user = getUserById(player.playerId);
                ...
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item name="player3Id" label="Team 2 - Player 1">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[1]?.members.map(
                          (player: Member) => {
                            const user = getUserById(player.playerId);
                  ...
                  <Col span={12}>
                    <Form.Item name="player4Id" label="Team 2 - Player 2">
                      <Select showSearch optionFilterProp="children">
                        {match?.teamResponse?.[1]?.members.map(
                          (player: Member) => {
                            const user = getUserById(player.playerId);
